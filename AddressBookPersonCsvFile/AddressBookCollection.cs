...
namespace AddressBookUsingCollection
{
    class AddressBookCollection
    {
        ...
        {
            string filePath = @"C:\kundan Kamble\source\repo\AddressBookUsingCollection\EmployeeContact.txt";
        ...
        {
            string folderPath = @"C:\kundan Kamble\source\repo\AddressBookUsingCollection\";
            foreach (var AddressBookItem in addressBookDictionary)
            {
        ...
        {
            string filePath = @"C:\kundan Kamble\source\repo\AddressBookUsingCollection\";
